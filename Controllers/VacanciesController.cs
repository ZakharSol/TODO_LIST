...
namespace To_Do_List.Controllers
{
    ...
    public class VacanciesController : Controller
    {
        ...
        public VacanciesController(To_Do_ListContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Description")] Vacancy vacancy)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Description")] Vacancy vacancy)
        {
            if (id != vacancy.Id)
            {
                return NotFound();
